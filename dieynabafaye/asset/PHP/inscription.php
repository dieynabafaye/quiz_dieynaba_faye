  ...
  <body>
    <div class="row">
        <div class="col-12 text-light header">
            ...
            <h1 class="text-center font-weight-bold">Le plaisir de joueur</h1>
        </div>
    </div>
        ...
        <div class="row ml-2">
            <div class="col-7">
                <form method="post" action="" class="form" id="form-inscription">
                    ...
                    <button type="submit" name="envoie" id="inscrire" class="btn btn-primary col-md-4">Créer compte</button>
                </form>
            </div>
            <div class="col-4">
                ...
                <h4 class="ml-4">Avatar Joueur</h4>
            </div>
        </div>
    </div>
